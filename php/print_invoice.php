...
ob_start();
	...
	$pdf->setY(132);$pdf->setX(89);
	$pdf->SetFont('Calibri','',11);   
	$pdf->Cell(55,$textypos,"DATOS PERSONALES");
	$pdf->setY(137);$pdf->setX(18);
	$pdf->SetFont('Calibri','',11);   
	...
	$pdf->setY(148);$pdf->setX(20);
	$pdf->SetFont('Calibri','',11);   
	$pdf->Cell(5,$textypos,"ALERGIAS");
	$pdf->setY(148);$pdf->setX(39);
	$pdf->SetFont('CalibriR','',11);   
	$pdf->Cell(5,$textypos,"NO");
	//---INVOICE
	$pdf->setY(148);$pdf->setX(47);
	$pdf->SetFont('Calibri','',11);   
	$pdf->Cell(5,$textypos,"",'TLRB','','C');
	
	$pdf->setY(148);$pdf->setX(56);
	$pdf->SetFont('CalibriR','',11);   
	$pdf->Cell(5,$textypos,"SI");
	//---INVOICE
	$pdf->setY(148);$pdf->setX(62);
	$pdf->SetFont('Calibri','',11);   
	$pdf->Cell(5,$textypos,"X",'TLRB','','C');
	
	$pdf->setY(148);$pdf->setX(72);
	$pdf->SetFont('Calibri','',11);   
	$pdf->Cell(5,$textypos,utf8_decode("ESPECIFIQUE"));
	//---INVOICE
	$pdf->setY(148);$pdf->setX(94.5);
	$pdf->SetFont('CalibriR','',11);   
	...
	$pdf->setY(166);$pdf->setX(20);
	$pdf->SetFont('Calibri','',11);   
	$pdf->Cell(5,$textypos,"CULTURALES");
	//------------
	$pdf->setY(172);$pdf->setX(26);
	$pdf->SetFont('CalibriR','',11);   
	$pdf->Cell(5,$textypos,"DANZA");
	//---INVOICE
	$pdf->setY(172);$pdf->setX(20);
	$pdf->SetFont('Calibri','',11);   
	$pdf->Cell(5,$textypos,"",'TLRB','','C');
	//------------
	$pdf->setY(179);$pdf->setX(26);
	$pdf->SetFont('CalibriR','',11);   
	$pdf->Cell(5,$textypos,utf8_decode("MÚSICA"));
	//---INVOICE
	$pdf->setY(179);$pdf->setX(20);
	$pdf->SetFont('Calibri','',11);   
	$pdf->Cell(5,$textypos,"",'TLRB','','C');
	//------------
	$pdf->setY(186);$pdf->setX(26);
	$pdf->SetFont('CalibriR','',11);   
	$pdf->Cell(5,$textypos,"PINTURA");
	//---INVOICE
	$pdf->setY(186);$pdf->setX(20);
	$pdf->SetFont('Calibri','',11);   
	$pdf->Cell(5,$textypos,"",'TLRB','','C');
	//------------
	$pdf->setY(193);$pdf->setX(26);
	$pdf->SetFont('CalibriR','',11);   
	$pdf->Cell(5,$textypos,"BANDA DE GUERRA");
	//---INVOICE
	$pdf->setY(193);$pdf->setX(20);
	$pdf->SetFont('Calibri','',11);   
	$pdf->Cell(5,$textypos,"",'TLRB','','C');
	
	
	$pdf->setY(166);$pdf->setX(63);
	$pdf->SetFont('Calibri','',11);   
	$pdf->Cell(5,$textypos,"DEPORTIVAS");
	//------------
	$pdf->setY(172);$pdf->setX(70);
	$pdf->SetFont('CalibriR','',11);   
	$pdf->Cell(5,$textypos,"BASQUET BOL");
	//---INVOICE
	$pdf->setY(172);$pdf->setX(64);
	$pdf->SetFont('Calibri','',11);   
	$pdf->Cell(5,$textypos,"",'TLRB','','C');
	//------------
	$pdf->setY(179);$pdf->setX(70);
	$pdf->SetFont('CalibriR','',11);   
	$pdf->Cell(5,$textypos,utf8_decode("VOLEIBOL"));
	//---INVOICE
	$pdf->setY(179);$pdf->setX(64);
	$pdf->SetFont('Calibri','',11);   
	$pdf->Cell(5,$textypos,"",'TLRB','','C');
	//------------
	$pdf->setY(186);$pdf->setX(70);
	$pdf->SetFont('CalibriR','',11);   
	$pdf->Cell(5,$textypos,"ATLETISMO");
	//---INVOICE
	$pdf->setY(186);$pdf->setX(64);
	$pdf->SetFont('Calibri','',11);   
	$pdf->Cell(5,$textypos,"",'TLRB','','C');
	//------------
	$pdf->setY(193);$pdf->setX(70);
	$pdf->SetFont('CalibriR','',11);   
	$pdf->Cell(5,$textypos,"BESISBOL");
	//---INVOICE
	$pdf->setY(193);$pdf->setX(64);
	$pdf->SetFont('Calibri','',11);   
	$pdf->Cell(5,$textypos,"",'TLRB','','C');
	...
	//------------
	$pdf->setY(172);$pdf->setX(108);
	$pdf->SetFont('CalibriR','',11);   
	$pdf->Cell(5,$textypos,"SOCCER");
	//---INVOICE
	$pdf->setY(172);$pdf->setX(102);
	$pdf->SetFont('Calibri','',11);   
	$pdf->Cell(5,$textypos,"",'TLRB','','C');
	//------------
	$pdf->setY(179);$pdf->setX(108);
	$pdf->SetFont('CalibriR','',11);   
	$pdf->Cell(5,$textypos,utf8_decode("KARATE DO"));
	//---INVOICE
	$pdf->setY(179);$pdf->setX(102);
	$pdf->SetFont('Calibri','',11);   
	$pdf->Cell(5,$textypos,"",'TLRB','','C');
	//------------
	$pdf->setY(186);$pdf->setX(108);
	$pdf->SetFont('CalibriR','',11);   
	$pdf->Cell(5,$textypos,"TAE KWON DO");
	//---INVOICE
	$pdf->setY(186);$pdf->setX(102);
	$pdf->SetFont('Calibri','',11);   
	$pdf->Cell(5,$textypos,"",'TLRB','','C');
	//------------
	$pdf->setY(193);$pdf->setX(108);
	$pdf->SetFont('CalibriR','',11);   
	$pdf->Cell(5,$textypos,"AJEDREZ");
	//---INVOICE
	$pdf->setY(193);$pdf->setX(102);
	$pdf->SetFont('Calibri','',11);   
	$pdf->Cell(5,$textypos,"",'TLRB','','C');
	
	
	$pdf->setY(166);$pdf->setX(138);
	$pdf->SetFont('Calibri','',11);   
	$pdf->Cell(5,$textypos,"OTRAS");
	//------------
	$pdf->setY(172);$pdf->setX(145);
	$pdf->SetFont('CalibriR','',11);   
	$pdf->Cell(5,$textypos,"STAFF");
	//---INVOICE
	$pdf->setY(172);$pdf->setX(139);
	$pdf->SetFont('Calibri','',11);   
	$pdf->Cell(5,$textypos,"",'TLRB','','C');
	//------------
	$pdf->setY(179);$pdf->setX(145);
	$pdf->SetFont('CalibriR','',11);   
	$pdf->Cell(5,$textypos,utf8_decode("PESAS"));
	//---INVOICE
	$pdf->setY(179);$pdf->setX(139);
	$pdf->SetFont('Calibri','',11);   
	$pdf->Cell(5,$textypos,"",'TLRB','','C');
	//------------
	$pdf->setY(186);$pdf->setX(145);
	$pdf->SetFont('CalibriR','',11);   
	$pdf->Cell(5,$textypos,"OTRAS");
	//---INVOICE
	$pdf->setY(186);$pdf->setX(139);
	$pdf->SetFont('Calibri','',11);   
	$pdf->Cell(5,$textypos,"X",'TLRB','','C');
	//------------
	$pdf->setY(193);$pdf->setX(145);
	$pdf->SetFont('CalibriR','',11);   
	...
	$pdf->Cell(5,$textypos,"",'TLRB','','C');
	//
	$pdf->setY(217);$pdf->setX(80);
	$pdf->SetFont('CalibriR','',11);   
	$pdf->Cell(5,$textypos,"CUAL:",'');
	
	if((utf8_decode($invoiceValues['exclusivo_servicio']))=='ACTIVIDADES-COMPLEMENTARIAS'){
	$pdf->setY(217);$pdf->setX(94);
	$pdf->SetFont('CalibriR','',11);   
	...
	$pdf->Cell(5,$textypos,"",'TLRB','','C');
	//
	$pdf->setY(224);$pdf->setX(38);
	$pdf->SetFont('CalibriR','',11);   
	$pdf->Cell(5,$textypos,"TIPO:",'');
	if((utf8_decode($invoiceValues['exclusivo_servicio']))=='BECA'){
	$pdf->setY(224);$pdf->setX(50);
	$pdf->SetFont('CalibriR','',11);   
